...
class product_category(models.Model):
    ...
    isactivitytype = fields.Boolean(
        string='Is Activity Type',
...
class hotel_housekeeping(models.Model):
    ...
    activity_lines = fields.One2many(
...
class hotel_housekeeping_activities(models.Model):
    ...
    clean_start_time = fields.Datetime(
        string='Clean Start Time',
        required=True
    )
    
    clean_end_time = fields.Datetime(
        string='Clean End Time',
        required=True
    )
